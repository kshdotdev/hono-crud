/**
 * Example: Basic CRUD Operations with Prisma + PostgreSQL
 *
...
app.doc('/openapi.json', {
  openapi: '3.1.0',
  info: {
    title: 'Basic CRUD Example - Prisma + PostgreSQL',
    version: '1.0.0',
    description: 'Demonstrates basic CRUD operations with hono-crud using Prisma and PostgreSQL.',
  },
});
...
initDb()
  .then(() => {
    console.log(`
=== Basic CRUD Example (Prisma + PostgreSQL) ===
